...
export default function Solutions() {
   ...
   let section_one_title =allPrismicSolutions.edges[0].node.data.section_one_title.text
   let section_two_content =allPrismicSolutions.edges[0].node.data.section_two_content.text
   let section_two_title =allPrismicSolutions.edges[0].node.data.section_two_title.text
                        ...
                        <div className="row">
                            ...
                            <div className=" colm col-md-6 col-lg-4 d-flex align-items-stretch  mb-lg-0">
                                <a href="#industries" className="icon-box" data-aos="fade-up" data-aos-delay="100">
                                    <h3 className="box-title">{content_solution1.solution_title.text}
                                         <div className="icon">
                                            <img src={solution1} />
                                        </div>
                                    </h3>
                                    <p className="description">{content_solution1.solution_description.text}</p>
                                </a>
                            ...
                            <div className="colm col-md-6 col-lg-4 d-flex align-items-stretch  mb-lg-0">
                                ...
                                <a href="#lifecycle" className="icon-box" data-aos="fade-up" data-aos-delay="100">
                                    ...
                                    <p className="description"> {content_solution3.solution_description.text} </p>
                                </a>
                        ...
                        <div className="row">
                            ...
                            <div className=" colm col-md-4 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                                ...
                                <a href="#services" className="icon-box" data-aos="fade-up" data-aos-delay="100">
                                    <h3 className="box-title">{content_solution2.solution_title.text}
                                        <div className="icon">
                                            <img src={solution2} />
                                        </div>
                                    </h3>
                                    <p className="description">{content_solution2.solution_description.text}</p>
                                </a>
                            </div>
                            <div className="colm col-md-4 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                                ...
                                <a href="#lifecycle" className="icon-box" data-aos="fade-up" data-aos-delay="100">
                                    ...
                                    <p className="description"> {content_solution4.solution_description.text} </p>
                                </a>
                            </div>
